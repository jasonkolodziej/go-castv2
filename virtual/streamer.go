...
func NewStream(
	URI string, // URI of raw RTSP stream
	codec string,
	storingDirectory string, // * Directory where to store video chunks and indexes. Should exist already
	keepFiles bool, // * Indicates if stream should be keeping files after it is stopped or clean the directory
	audio bool, // * Indicates if Audio should be enabled or not
